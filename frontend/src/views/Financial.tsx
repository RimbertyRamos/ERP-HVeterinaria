...
export const Financial: React.FC = () => {
  ...
  const promedioCobro =
    recibosFiltrados.length > 0 ? totalIngresos / recibosFiltrados.length : 0;
  ...
  const chartData = useMemo(() => {
    if (periodo === "Semana") {
      return Array.from({ length: 7 }, (_, i) => {
        ...
        return {
          dia: start.toLocaleDateString("es-ES", {
            weekday: "short",
            day: "numeric",
          }),
          ingresos: total,
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-emerald-50 dark:bg-emerald-900/10 p-6 rounded-2xl border border-emerald-100 dark:border-emerald-900/30">
          ...
          <p className="text-emerald-700 dark:text-emerald-400 text-sm font-bold">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/10 p-6 rounded-2xl border border-blue-100 dark:border-blue-900/30">
          <div className="flex justify-between items-center mb-4">
            ...
            <span className="text-xs font-bold text-blue-600">
              {loading ? "—" : `${recibosFiltrados.length} cobros`}
            </span>
          </div>
