/**
 * Datos de primeros auxilios veterinarios.
 * Separados del servicio para mantener alta cohesión: el servicio maneja la lógica
 * de matching y respuesta, este archivo contiene los datos de dominio.
 */

/** Estructura de una guía de primeros auxilios. */
export interface PrimerAuxilio {
  /** Palabras clave que activan esta guía. */
  kw: string[];
  /** Texto de respuesta con instrucciones. */
  texto: string;
}

// ── Respaldo SIN IA: guías de primeros auxilios por síntoma ──────────────────
export const DISCLAIMER = "⚠️ Primeros auxilios — NO reemplaza al veterinario.\n\n";
...
export const PRIMEROS_AUXILIOS: PrimerAuxilio[] = [
  {
    kw: [
