...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var roleAdmin, password_hash;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db_1.default.role.upsert({
                        where: { nombre: 'Admin' },
                        update: {},
                        create: {
                            nombre: 'Admin',
                ...
                case 3:
                    ...
                    return [4 /*yield*/, db_1.default.usuario.upsert({
                ...
                case 4:
                    _a.sent();
                    console.log('Seed exitoso: Usuario admin@veterinaria.com creado con rol Admin.');
                    return [2 /*return*/];
            }
        });
    });
